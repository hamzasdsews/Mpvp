...
public class BackHead {
    ...
    private static ItemStack createSkull(final String url, final String name) {
        ...
        final GameProfile profile = new GameProfile(UUID.fromString("f360ac56-14a6-40de-a3af-0ff07c1d28bb"), null);
    ...
    public enum Heads
    {
        Head("Head", 0, "Head", 0, "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYWZkMjQwMDAwMmFkOWZiYmJkMDA2Njk0MWViNWIxYTM4NGFiOWIwZTQ4YTE3OGVlOTZlNGQxMjlhNTIwODY1NCJ9fX0=", "Head");
